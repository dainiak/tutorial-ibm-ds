...
# TASK 2: Add a callback function for `site-dropdown` and `success-pie-chart`
@app.callback(
...
# TASK 4: Add a callback function for `site-dropdown` and `payload-slider` to render the scatter plot
@app.callback(
